...
if __name__ == "__main__":
    run_validation_demo()
    # Uncomment the line below to run the end-to-end demo (requires valid OPENAI_API_KEY)
    run_end_to_end_demo()  

# =========================
# SCRIPT OUTPUT (for reference)
# =========================
# The following is the output from running this script:
#
# ============================================================
...
#   Color: Navy Blue
#   Brand: StyleCo
#   Tags: ['casual', 'cotton', 'comfort']
#
# --- Test 2: Negative Price ---
# ✗ VALIDATION FAILED
#   Error: price: Input should be greater than 0
#
# --- Test 3: Missing Product Name ---
# ✗ VALIDATION FAILED
#   Error: product_name: Field required
#
# --- Test 4: Invalid Category ---
# ✗ VALIDATION FAILED
#   Error: category: Input should be 'Apparel', 'Accessories', 'Footwear', 'Electronics', 'Home', 'Beauty', 'Sports' or 'Other'
#
# --- Test 5: No Image Provided ---
# ✗ VALIDATION FAILED
#   Error: : Value error, Either image_url or image_base64 must be provided
#
# --- Test 6: Invalid Currency Code ---
# ✗ VALIDATION FAILED
#   Error: currency: String should match pattern '^[A-Z]{3}$'
#
# --- Test 7: Product Name Too Short ---
# ✗ VALIDATION FAILED
#   Error: product_name: String should have at least 3 characters
#
# --- Test 8: Price Too High ---
# ✗ VALIDATION FAILED
#   Error: price: Input should be less than or equal to 100000
#
# ============================================================
...
# ============================================================
# C:\Users\Adetunji\IRONHACK_LAB\API_Calling_JSON\API_Calling_with_JSON\product_generator_refactored.py:111: DeprecationWarning: datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).
#   timestamp: str = Field(default_factory=lambda: datetime.utcnow().isoformat())
# ✓ SUCCESS
# Processing time: 19.74s
# Title: DenimCo Classic Denim Jacket - Timeless Blue
# Description: Elevate your wardrobe with the DenimCo Classic Denim Jacket, a timeless piece that never goes out of style. Crafted from high-quality blue denim, this jacket offers both durability and comfort. Its versatile design makes it perfect for layering over any outfit, whether you're dressing up or keeping it casual. With its classic fit and stylish details, this jacket is a must-have staple for any fashion-forward individual.
# Features: ['High-quality blue denim', 'Classic fit', 'Versatile design']
# Tags: ['denim jacket', 'classic style', 'versatile apparel']
